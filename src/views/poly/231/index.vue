...
export default class Poly extends Mixins(pageCommonMix) {
  ...
  private async created() {
    try {
      let sdkUrl = 'https://newh5.lequ.com/Public/h5/js/lq.js';
      if (window.location.protocol === 'http:') {
        sdkUrl = 'http://res.lequ.com/Public/h5/js/lq.js';
      }
      await loadJS(sdkUrl);
